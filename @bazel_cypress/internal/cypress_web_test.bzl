...
ATTRS = dict(
    ...
    entry_point = attr.label(
        ...
        default = Label("//@bazel/cypress/internal:run-cypress.js"),
    ),
    plugin_file = attr.label(
        default = Label("//@bazel/cypress/internal:plugins/base.js"),
        allow_single_file = True,
    ...
    _plugin_wrapper = attr.label(
        default = Label("//@bazel/cypress/internal:plugins/index.js.tpl"),
        allow_single_file = True,
    ),
)
